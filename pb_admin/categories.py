...
class Categories():
    ...
    async def get_list(self, search: str = '', is_lite: bool = True) -> list[schemas.Category]:
        ...
        while is_next_page:
            async with self.session.get(f'{self.site_url}/nova-api/categories', params=params) as resp:
